                ...
                @foreach($team_members as $team_member)
                    <div class="col-lg-3 col-md-6">
                        <div class="item pb_50">
                            ...
                            <div class="text">
                                <h2><a href="{{route('team_member',$team_member->slug)}}">{{$team_member->name}}</a>
                                </h2>
                                    ...
                                    <div class="social">
                                        <ul>
                                            @if($team_member->facebook != '')
                                                <li><a href="{{$team_member->facebook}}"><i
                                                            class="fab fa-facebook-f"></i></a></li>
                                            @endif
                                            @if($team_member->twitter != '')
                                                <li><a href="{{$team_member->twitter}}"><i
                                                            class="fab fa-twitter"></i></a></li>
                                            @endif
                                            @if($team_member->linkedin != '')
                                                <li><a href="{{$team_member->linkedin}}"><i
                                                            class="fab fa-linkedin-in"></i></a></li>
                                            @endif
                                            @if($team_member->instagram != '')
                                                <li><a href="{{$team_member->instagram}}"><i
