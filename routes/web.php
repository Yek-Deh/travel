...
Route::post('/enquiry/submit/{id}', [FrontController::class, 'enquiry_form_submit'])->name('enquiry_form_submit');
...
Route::get('/registration_verify/{email}/{token}', [FrontController::class, 'registration_verify'])->name('registration_verify');
...
Route::middleware('admin')->prefix('admin')->group(function () {
    ...
    Route::post('/destination-photo/{id}', [AdminDestinationController::class, 'destination_photo_submit'])->name('admin_destination_photo_submit');
    ...
    Route::post('/destination-video/{id}', [AdminDestinationController::class, 'destination_video_submit'])->name('admin_destination_video_submit');
    ...
    Route::post('/package-video/{id}', [AdminPackageController::class, 'package_video_submit'])->name('admin_package_video_submit');
    ...
    Route::post('/package-faq/{id}', [AdminPackageController::class, 'package_faq_submit'])->name('admin_package_faq_submit');
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/forgot-password', [AdminAuthController::class, 'forgot_password'])->name('admin_forgot_password');
    Route::post('/forgot-password', [AdminAuthController::class, 'forgot_password_submit'])->name('admin_forgot_password_submit');
