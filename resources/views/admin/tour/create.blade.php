    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header justify-content-between">
                <h1>Create Tour</h1>
                <div class="ml-auto">
                    <a href="{{route('admin_tour_index')}}" class="btn btn-primary"><i class="fas fa-plus">View
                            All</i></a>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker1" type="text" name="tour_start_date" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker2" type="text" name="tour_end_date" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input id="datepicker3" type="text" name="booking_end_date" class="form-control"
