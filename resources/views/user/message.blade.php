                ...
                @if($message_check)
                    ...
                    <div class="col-lg-4 col-md-12">
                        ...
                        <form action="{{route('user_message_submit')}}" method="post">
                            @csrf
                            <div class="mb-2">
                                <textarea name="comment" class="form-control h-150" cols="30" rows="10"
                ...
                @else
                    <div class="col-lg-9 col-md-12">
                        <div class="alert alert-danger">
                            No Message Found <br>
                            <a href="{{route('user_message_start')}}" class="text-decoration-underline">Please click
                                here to start messaging</a>
                        </div>
                    </div>
                @endif
            </div>
