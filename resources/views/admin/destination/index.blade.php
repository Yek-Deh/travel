                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="example1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset('uploads/'.$destination->featured_photo)}}" alt="" srcset="" class="w_200">
                                            </td>
                                            <td>{{$destination->name}}</td>
                                            <td>
                                                <a href="{{route('admin_destination_photos',$destination->id)}}" class="btn btn-outline-success btn-sm">Photo Gallery</a>
                                                <a href="{{route('admin_destination_videos',$destination->id)}}" class="btn btn-outline-success btn-sm">Video Gallery</a>
                                            </td>
