                ...
                <div class="col-md-12">
                    ...
                    @if($package->total_score || $package->total_rating)
                        <div class="review">
                            <div class="set">
                                @php
                                    $package_rating = ceil($package->total_score/$package->total_rating);
                                @endphp
                                @for($i=1; $i <= 5; $i++)
                                    @if($i <= $package_rating)
                            ...
                            @if($package_itineraries->count() >0)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab-2" data-bs-toggle="tab"
                                            ...
                                            type="button" role="tab" aria-controls="tab-2-pane" aria-selected="false">
                                        Itinerary
                                    </button>
                                </li>
                            @endif
                            ...
                            @if($package_faqs->count() >0 )
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tab-5" data-bs-toggle="tab"
                                            data-bs-target="#tab-5-pane"
                                            type="button" role="tab" aria-controls="tab-5-pane" aria-selected="false">
                                        FAQ
                                    </button>
                                </li>
                            @endif
                        ...
                        <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="row">
                                            @foreach($package_amenities_include as $item)
                                                <div class="col-lg-3 mb_15">
                                                    <i class="fas fa-check"></i> {{$item->amenity->name}}</div>
                                            @endforeach
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="amenity">
                                        <div class="row">
                                            @foreach($package_amenities_exclude as $item)
                                                <div class="col-lg-3 mb_15">
                                                    <i class="fas fa-times"></i> {{$item->amenity->name}}</div>
                                            @endforeach
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="tab-pane fade" id="tab-6-pane" role="tabpanel" aria-labelledby="tab-6"
                                ...
                                <div class="review-package">
                                    ...
                                    @if(Auth::guard('web')->check() )
                                        @php
                                            $review_possible = App\Models\Booking ::where('package_id',
                                            $package->id)->where('user_id',Auth::guard('web')->id())
                                        ...
                                        @if($review_possible > 0)
                                            @php
                                                ...
                                                ('user_id',Auth::guard('web')->id())->count() > 0 ?
                                            ...
                                            @endif
                                        @else
                                            <div class="alert alert-danger">You have to book this package to review.
                                            </div>
                                        @endif
                                    @else
                                        <a href="{{ route('login') }}" class="btn btn-danger">Login to
                                            Review</a>
                                    @endif
                                </div>
                                <!-- // Review -->
                            ...
                            <div class="tab-pane fade" id="tab-7-pane" role="tabpanel" aria-labelledby="tab-7"
                                ...
                                <div class="enquiry-form">
                                    <form action="{{route('enquiry_form_submit',$package->id)}}" method="post">
                                        @csrf
                                        <div class="mb-3">
                            ...
                            <div class="tab-pane fade" id="tab-8-pane" role="tabpanel" aria-labelledby="tab-8"
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                @foreach($tours as $tour)
                                                    ...
                                                    if($tour->total_seat == '-1') {$remaining_seats = 'Unlimited';}
                                                    else{ $remaining_seats = $tour->total_seat - $total_booked_seats;}
                                                    @endphp
                                                    <h2 class="mt_30">
                                                        <input type="radio" name="tour_id" value="{{$tour->id}}"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="text" name="" class="form-control"
                                                                           id="totalAmount" value="${{$package->price}}"
                                                                           disabled>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                ...
                                @else
                                    <div class="alert alert-danger">No Tour Available</div>
                                @endif
                                <!-- // Booking -->
                            </div>
